...
return [
    ...
    'max_ad_limit' => [
        ...
        'msg' => "Sie haben Ihr kostenloses Anzeigenlimit erreicht.",
        'nextBtn' => "Anzeigen anzeigen",
        'cancelBtn' => "Oder Abbrechen",
    ],
    'create_ad_with_post_cat' => [
        'title' => "Schalten Sie eine Anzeige in nur 30 Sekunden",
        'msg' => "Bitte schalten Sie NICHT mehrere Anzeigen für dieselben Artikel oder Dienstleistungen. Alle doppelten, Spam- und falsch kategorisierten Anzeigen werden gelöscht.",
        'nextBtn' => "Nächster",
        'cancelBtn' => "Oder Abbrechen",
        'link' => "",
    ],
