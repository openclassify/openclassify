...
return [
    ...
    'permission_error' => 'Δεν έχετε άδεια για αυτήν την ενέργεια',
    'currency_converter_not_available' => 'Ο μετατροπέας νομίσματος δεν είναι διαθέσιμος.',
    'option_saved' => 'Η επιλογή αποθηκεύτηκε',
    'do_you_want_to_save_the_option' => 'Θέλετε να αποθηκεύσετε την επιλογή;',
    'you_can_not_delete_a_system_status' => 'Δεν μπορείτε να διαγράψετε μια κατάσταση συστήματος!',
