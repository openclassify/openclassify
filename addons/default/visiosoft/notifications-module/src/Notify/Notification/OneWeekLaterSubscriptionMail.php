...
class OneWeekLaterSubscriptionMail extends Notification implements ShouldQueue
{
    ...
    public function toMail(UserInterface $notifiable)
    {
        ...
        return (new MailMessage())
            ...
            ->subject(trans('visiosoft.module.notifications::notification.one_week_later_subscription_subject'))
