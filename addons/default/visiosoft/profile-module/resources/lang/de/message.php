...
return [
    ...
    "success_update"      => "Profilaktualisierung erfolgreich!",
    "adress_success_update"      => "Adressaktualisierung erfolgreich!",
    "adress_success_create"      => "Adresse erfolgreich erstellen!",
    "login_error" => "Falsches Login oder Passwort.",
    "login_noMail_old_user" => "Die von Ihnen eingegebene E-Mail-Adresse wurde nicht gefunden.",
    "login_noMail_old_user2" => "Bitte überprüfen Sie die E-Mail-Adresse und versuchen Sie es erneut.",
    "login_noMail_old_user3" => "Wenn das Problem weiterhin besteht, wenden Sie sich bitte an 'info@openclassify.com'.",
    ...
    "notified_about_ads" => "Benachrichtigungen über meine Anzeigen zulassen",
    ...
    "no_extend_package" => "Keine Anzeigenpakete verlängern",
    "saved" => "Gerettet!",
