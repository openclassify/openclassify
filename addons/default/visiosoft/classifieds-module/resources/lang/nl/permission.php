...
return [
    'classifieds' => [
        'name'   => 'classifiedertenties',
        'option' => [
            'read'   => 'Kunnen classifiedertenties lezen?        ',
            'write'  => 'Kan ik classifiedertenties maken / bewerken?        ',
            'delete' => 'Kunnen classifiedertenties worden verwijderd?',
        ],
    ],
    'categories' => [
        'name'   => 'Categorieën',
    ...
    'custom_field_classifieds' => [
        'name'   => 'Aangepaste veldclassifiedertenties',
        'option' => [
            'read'   => 'Kan aangepaste veldclassifiedertenties lezen?        ',
            'write'  => 'Kan aangepaste veldclassifiedertenties maken / bewerken?        ',
            'delete' => 'Kan aangepaste veldclassifiedertenties verwijderen?',
        ],
    ],
    'cf_values' => [
        'name'   => 'Zie waarden',
