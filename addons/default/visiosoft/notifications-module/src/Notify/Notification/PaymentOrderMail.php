...
class PaymentOrderMail extends Notification implements ShouldQueue
{
    ...
    {
        $subject = trans('visiosoft.module.notifications::notification.payment_order_user_message_subject');
        $line1 = trans('visiosoft.module.notifications::notification.payment_order_user_message_line');
