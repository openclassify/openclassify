...
return [
    ...
    'required_district' => [
        'name' => 'Zorunlu Bölge',
        'instructions' => 'Bir adres eklemek ilçe yükümlülüğünü temsil eder.',
    ],
    'show_extends_actions' => [
        'name' => 'Extends Eylemlerini Göster',
        'instructions' => 'Profilim Reklamlar sayfasında bulunan Genişletme seçeneklerini temsil eder.',
    ],
];
