...
@if($socialProviders->isNotEmpty())
    <div class="row" style="gap:var(--space-3)">
        <span class="divider" style="flex:1 1 auto"></span>
        <span class="text-meta">{{ __('user::messages.or') }}</span>
        <span class="divider" style="flex:1 1 auto"></span>
    </div>

    <div class="stack stack--tight">
        @foreach($socialProviders as $provider)
            <a href="{{ $provider['url'] }}" class="button button--secondary button--block">
