...
class UnpublishAdAdminMail extends Notification implements ShouldQueue
{
    ...
    {
        $subject = trans('visiosoft.module.notifications::notification.unpublish_ad_user_message_subject');
        $line1 = trans('visiosoft.module.notifications::notification.unpublish_ad_user_message_line1');
