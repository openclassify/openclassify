...
$(document).ready(function () {
    ...
    if (default_GET == 1) {
        $('#is_get_classified').prop('checked', true);
    }
});
...
$(document).ready(function () {
    ...
    $('textarea[data-field="classifieds_desc"]:not(.hasEditor)').each(function () {
...
$(document).ready(function () {
    ...
    $('#createEditClassifiedForm').submit(function () {
    ...
    $('#configurationForm').submit(function (e) {
        e.preventDefault();
        crudAjax($(this).serialize(), '/classifieds/configuration/ajax/create', 'POST', function (callback) {
    ...
    $(document).on('click', '.remove-conf', function () {
        ...
        crudAjax({id: id}, '/classifieds/configuration/ajax/delete', 'POST', function (callback) {
