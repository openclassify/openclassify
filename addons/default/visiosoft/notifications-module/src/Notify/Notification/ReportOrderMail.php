...
class ReportOrderMail extends Notification implements ShouldQueue
{
     ...
     * @param $redirect
     */
    public function __construct($userMsg,$user,$settings)
    {
    ...
    {
        $subject = trans('visiosoft.module.notifications::notification.report_order_user_message_subject');
        $line1 = trans('visiosoft.module.notifications::notification.report_order_user_message_line');
        ...
        return (new MailMessage())
            ...
            ->line($line1)
            ->line("\"<font color='black'>" . $this->userMsg . "</font>\"")
