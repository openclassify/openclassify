...
return [
    'error_added_cart' => 'O produto solicitado está ausente ou inativo',
    'please_payment' => 'Por favor pague',
    'bank_account_info' => 'informações de conta bancária',
    'agreement' => 'Ao clicar em Publicar, você concorda com nossos Termos de Uso e Política de Privacidade e reconhece que você é o legítimo proprietário deste item.',
    'update_category_msg' => 'A categoria de classificados será atualizada.',
    ...
    'delete_author_error' => 'Você não pode excluir uma postagem que não pertence a você',
    'success_delete' => 'Anúncio excluído',
    'pending_ad_status' => 'Seu anúncio está com aprovação pendente do Editor.',
    'extended' => ': número anúncio (s) foi estendido com sucesso.',
