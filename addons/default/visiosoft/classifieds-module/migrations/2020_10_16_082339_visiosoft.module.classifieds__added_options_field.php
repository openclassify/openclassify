...
class VisiosoftModuleClassifiedsAddedOptionsField extends Migration
{
	...
	protected $fields = [
		'product_options_value' => [
			...
			'config' => [
				'mode'    => 'lookup',
				'related' => \Visiosoft\ClassifiedsModule\ProductoptionsValue\ProductoptionsValueModel::class,
			],
		]
	];
