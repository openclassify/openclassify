...
class LastdaySubscriptionMail extends Notification implements ShouldQueue
{
    ...
    public function toMail(UserInterface $notifiable)
    {
        ...
        return (new MailMessage())
            ...
            ->subject(trans('visiosoft.module.notifications::notification.last_1_day_subscription_subject'))
