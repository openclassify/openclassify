...
class RefundOrderMail extends Notification implements ShouldQueue
{
    ...
    {
        $subject = trans('visiosoft.module.notifications::notification.refund_order_user_message_subject');
        $line1 = trans('visiosoft.module.notifications::notification.refund_order_user_message_line');
