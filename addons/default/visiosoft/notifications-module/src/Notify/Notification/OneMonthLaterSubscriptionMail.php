...
class OneMonthLaterSubscriptionMail extends Notification implements ShouldQueue
{
    ...
    public function toMail(UserInterface $notifiable)
    {
        ...
        return (new MailMessage())
            ...
            ->subject(trans('visiosoft.module.notifications::notification.one_month_later_subscription_subject'))
