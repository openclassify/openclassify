...
class VisiosoftModuleClassifiedsChangeProductOptionsValue extends Migration
{
    ...
    public function up()
    {
        if (!$field = $this->fields()->findBySlugAndNamespace('product_options_value', 'classifieds')) {
            return;
        }
