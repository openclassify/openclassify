...
class UpdateAdAdminMail extends Notification implements ShouldQueue
{
    ...
    {
        $subject = trans('visiosoft.module.notifications::notification.update_ad_user_message_subject');
        $line1 = trans('visiosoft.module.notifications::notification.update_ad_user_message_line1');
