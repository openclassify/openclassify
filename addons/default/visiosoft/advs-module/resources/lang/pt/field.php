<?php
 ...
 return[
   ...
   "next_add_advs_title"   =>   [
      "name"      =>"Poste um anúncio em apenas 30 segundos",

   ],
   "next_add_advs_msg"   =>   [
      "name"      =>"Por favor,
      NÃO poste vários anúncios para os mesmos itens ou serviços. Todos os anúncios duplicados,
      spam e categorizados incorretamente serão excluídos.",
   ...
   "price-low"   =>"Preço baixo para alto",
   "newest"   =>"O mais novo",
