...
return [
    'classifieds' => [
        'name'   => 'Classifieds',
        'option' => [
            'read'   => 'Can read classifieds?',
            'write'  => 'Can create/edit classifieds?',
            'delete' => 'Can delete classifieds?',
        ],
    ],
    'categories' => [
        'name'   => 'Categories',
    ...
    'custom_field_classifieds' => [
        'name'   => 'Custom field classifieds',
        'option' => [
            'read'   => 'Can read custom field classifieds?',
            'write'  => 'Can create/edit custom field classifieds?',
            'delete' => 'Can delete custom field classifieds?',
        ],
    ],
    'cf_values' => [
        'name'   => 'Cf values',
