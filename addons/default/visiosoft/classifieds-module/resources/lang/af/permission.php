...
return [
    'classifieds' => [
        'name'   => 'Classifiedertensies',
        'option' => [
            'read'   => 'Kan classifiedertensies gelees word?',
            'write'  => 'Kan u classifiedertensies skep / wysig?',
            'delete' => 'Kan classifiedertensies verwyder word?',
        ],
    ],
    'categories' => [
        'name'   => 'Kategorieë',
    ...
    'custom_field_classifieds' => [
        'name'   => 'Pasgemaakte veldclassifiedertensies',
        'option' => [
            'read'   => 'Kan u persoonlike veldclassifiedertensies lees?',
            'write'  => 'Kan u persoonlike veldclassifiedertensies skep / wysig?',
            'delete' => 'Kan u persoonlike veldclassifiedertensies verwyder?',
        ],
    ],
    'cf_values' => [
        'name'   => 'Cf waardes',
